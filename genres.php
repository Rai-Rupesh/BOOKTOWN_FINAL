...
<section id="book1" class="section-p1">
   ...
   <h1 class= "title">Sci-fi 📚 </h1>

   <div class="book-container">

      <?php  
         $select_products = mysqli_query($conn, "SELECT * FROM `products` where `category` ='sci-fi'") or die('query failed');
...
<section id="book1" class="section-p1">
   ...
   <div class="book-container">
      ...
      <?php  
         $select_products = mysqli_query($conn, "SELECT * FROM `products` where `category` ='manga'") or die('query failed');
         if(mysqli_num_rows($select_products) > 0){
            while($fetch_products = mysqli_fetch_assoc($select_products)){
      ?>
     <form action="" method="post" class="books">
...
<section id="book1" class="section-p1">
   ...
   <div class="book-container">
      ...
      <?php  
         $select_products = mysqli_query($conn, "SELECT * FROM `products` where `category` ='thriller'") or die('query failed');
         if(mysqli_num_rows($select_products) > 0){
            while($fetch_products = mysqli_fetch_assoc($select_products)){
      ?>
     <form action="" method="post" class="books">
