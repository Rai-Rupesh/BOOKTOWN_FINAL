                    ...
                    <from class="books" method="post">
                        ...
                        <div class="shutter">
                            <div class="cart-link">
                                ...
                                <h5 id="cart-link3"><a href="products.php">view more</a></h5>
                                <input type="number" min="1" name="product_quantity" value="1" class="qty">
                                <input type="submit" value="add to cart" name="add" class="btn" style='cursor:pointer;'>
